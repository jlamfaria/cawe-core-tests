role_to_assume       = "arn:aws:iam::500643607194:role/cawe/cawe-developer"
...
monitoring-exporter_trusted_entities = ["arn:aws:iam::051351247033:role/cawe/cawe-monitoring-exporter-role"]
...
blackbox_tag   = "int-adv"
prometheus_tag = "int-adv"

metric_egress_url  = "https://metrics-egress.int.eu-central-1.cawe.daytona.eu-central-1.aws.cloud.bmw"
metric_injest_url = "https://metrics-injest.int.eu-central-1.cawe.daytona.eu-central-1.aws.cloud.bmw"
...
endpointCn = "https://u78o4wm4mi.execute-api.cn-north-1.amazonaws.com.cn/webhook"
