...
module "iam-cawe-developer" {
    ...
    trusted_entities = concat(module.product.spaceship-team-arns-cn,["arn:aws-cn:iam::090973320140:user/service.cawe-github-actions"], ["arn:aws-cn:iam::${module.product.cawe-admin.cn.e2e}:role/cawe/cawe-developer"])
