...
module "network" {
    ...
    vpc_cidr_eu-central-1        = "10.19.64.0/18"
    private_subnets_eu-central-1 = ["10.19.64.0/20", "10.19.80.0/20", "10.19.96.0/20"]
    public_subnets_eu-central-1  = ["10.19.112.0/21", "10.19.120.0/22", "10.19.124.0/22"]
    ...
    vpc_cidr_us-east-1        = "10.19.56.0/21"
    private_subnets_us-east-1 = ["10.19.61.0/24", "10.19.62.0/24", "10.19.63.0/24"]
    public_subnets_us-east-1  = ["10.19.58.0/24", "10.19.59.0/24", "10.19.60.0/24"]

    vpc_cidr_ap-northeast-2        = "10.19.48.0/21"
    private_subnets_ap-northeast-2 = ["10.19.48.0/24", "10.19.49.0/24", "10.19.50.0/24"]
    public_subnets_ap-northeast-2  = ["10.19.51.0/24", "10.19.52.0/24", "10.19.53.0/24"]
...
module "iam-lambda-webhook" {
    ...
    sqs_macos_arn = module.sqs.sqs_arn
    account_type  = var.account_type
}
...
module "webhook-receiver" {
    ...
    macos_queue_url       = module.sqs.queue_url
...
module "image_transfer_bucket" {
    ...
    project_name     = var.project_name
    allowed_accounts = ["810674048896","088012017805","339712784782"]
}
...
module "spaceship-helper-github-app-sops" {
    source      = "../modules/sops"
    secret_file = "secrets/spaceship_helper_github_app.json"
    input_type = "json"
}

module "spaceship-helper-github-app" {
    source       = "../modules/secretsmanager"
    secret_name  = "spaceship/spaceship-helper-github-app"
    secret_value = module.spaceship-helper-github-app-sops.secret_content
    tags = { "Access" : "build" }
}
