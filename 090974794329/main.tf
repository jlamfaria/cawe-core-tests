...
module "iam-cawe-developer" {
    ...
    trusted_entities = concat(module.product.spaceship-team-arns-cn,["arn:aws-cn:iam::090974794329:user/service.cawe-github-actions"], ["arn:aws-cn:iam::${module.product.cawe-admin.cn.e2e}:role/cawe/cawe-developer"])
...
module "iam-cawe-packer" {
    ...
    kms_arns         = [
        data.aws_kms_alias.kms_key.arn
    ]
    account_type = var.account_type
}
